        ...
        <table class="auto-style6">
            <tr>
                <td class="auto-style17">
                    <asp:Button ID="Button1" runat="server" Height="37px" OnClick="Button1_Click" Text="+" Width="40px" />
                </td>
                <td class="auto-style15">
                    <asp:Button ID="Button2" runat="server" Height="40px" OnClick="Button2_Click" Text="-" Width="38px" />
                </td>
    ...
    <asp:Panel ID="Panel6" runat="server" CssClass="auto-style9">
                <table class="auto-style6">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="Button8" runat="server" Height="30px" OnClick="Button8_Click" Text="-" Width="30px" />
                        </td>
                        <td>KATEGORİ EKLE</td>
                    </tr>
                </table>
